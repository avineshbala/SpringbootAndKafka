...
* The original package name 'com.demo.inventory.order-Inventory-service' is invalid and this project uses 'com.demo.inventory.order_Inventory_service' instead.
